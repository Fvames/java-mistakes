...
public class BetterBankService {
	public static String requestPrefix = "http://localhost:45678/reflection";
    ...
    private static String remoteCall(AbstractAPI api) throws IOException {
        ...
        Arrays.stream(api.getClass().getDeclaredFields()) //获得所有字段
                ...
                .forEach(field -> {
					packageData(api, stringBuilder, field);
				});
        //签名逻辑
        ...
        //发请求
        String result = Request.Post(requestPrefix + bankAPI.url())
	...
	private static void packageData(AbstractAPI api, StringBuilder stringBuilder, Field field) {
		//获得注解
